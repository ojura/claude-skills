...
Faithful means faithful: keep the false starts, the "wait—" self-corrections, the drafts, the discarded side-branches. Those are the point: they are exactly what summarization deletes, and discarded branches are often the thing the user needed (they can grab a side-candidate you'd never have promoted into the answer).
